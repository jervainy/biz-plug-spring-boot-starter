...
open class PlugBeanPostProcessor: BeanPostProcessor, Ordered {

    override fun postProcessAfterInitialization(bean: Any, beanName: String): Any? {
        if (bean is PlugContextCustomizer) {
            PlugContextHolder.addCustomizer(bean)
        }
        ...
        mapInfo.forEach { (t, u) -> PlugContextHolder.addPlugMapInfo(t, u) }
